...
- performant syntax highlighting in the markdown editor with incremental reparsing
- standardized markdown parsing between the client and server
- for the server to be able to correctly parse mentions (ignoring escapes and codeblocks), as well as sanitize custom emoji
