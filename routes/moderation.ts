...
import { AuditLogEntry, AuditLogEntryId, Media, MediaId, Member, MemberId, Message, MessageId, Room, RoomId, Thread, ThreadId, Uint, User, UserId } from "../types.ts";
...
export const ReportCreateMessage = createRoute({
  method: "post",
  path: "/api/v1/rooms/{room_id}/threads/{thread_id}/messages/{message_id}/report",
