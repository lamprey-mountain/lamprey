...
use crate::{
    metrics::{
        CHANNEL_COUNT_CALENDAR, CHANNEL_COUNT_DM, CHANNEL_COUNT_GDM, CHANNEL_COUNT_TEXT,
        CHANNEL_COUNT_THREAD_PRIVATE, CHANNEL_COUNT_THREAD_PUBLIC, CHANNEL_COUNT_TOTAL,
        CHANNEL_COUNT_VOICE, ROOM_COUNT_PRIVATE, ROOM_COUNT_PUBLIC, ROOM_COUNT_TOTAL,
        USER_COUNT_BOT, USER_COUNT_GUEST, USER_COUNT_PUPPET, USER_COUNT_PUPPET_BOT,
        USER_COUNT_REGISTERED, USER_COUNT_TOTAL, USER_COUNT_WEBHOOK,
    },
    routes::util::Auth,
