...
use crate::types::AutomodRuleData;
...
impl DataAutomod for Postgres {
    async fn automod_rule_create(
        ...
        query!(
            "INSERT INTO automod_rule (id, room_id, name, enabled, data) VALUES ($1, $2, $3, true, $4)",
            *rule_id,
            *room_id,
            create.name,
    ...
    async fn automod_rule_update(
        ...
        query!(
            "UPDATE automod_rule SET name = $2, enabled = $3, data = $4 WHERE id = $1",
            *rule_id,
            name,
            enabled,
            serde_json::to_value(data)?
