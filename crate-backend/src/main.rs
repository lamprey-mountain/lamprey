...
#[openapi(
    components(schemas(
        ...
        // script types
        common::v1::types::script::Script,
        common::v1::types::script::ScriptCreate,
        common::v1::types::script::ScriptContentUpdate,
        common::v1::types::script::ScriptVersion,
        common::v1::types::script::ScriptStatus,
        common::v1::types::script::ScriptFormat,
        common::v1::types::script::ScriptLocation,
        common::v1::types::script::ScriptLocationSet,
        common::v1::types::script::ScriptMetadata,
        common::v1::types::script::ScriptInput,
        common::v1::types::script::ScriptInputType,
        common::v1::types::script::ScriptEffect,
        common::v1::types::script::ScriptPermission,
        common::v1::types::script::ScriptPermissionGrant,
        common::v1::types::script::ScriptVersionStatus,
        common::v1::types::script::Run,
        common::v1::types::script::RunStatus,
        common::v1::types::script::RunLogEntry,
        common::v1::types::script::RunCreateTrigger,
        common::v1::types::script::ScriptDependency,
        common::v1::types::script::ScriptDependencyLink,
        common::v1::types::script::ScriptDependencyGraph,
        common::v1::types::script::ScriptDependenciesUpdate,
        common::v1::types::script::RunLogLevel,
        common::v1::types::script::RunLogSource,
        common::v1::types::script::RunTrace,
        common::v1::types::script::RunMetrics,
        common::v1::types::script::RunMetricsQuery,
        // media types
