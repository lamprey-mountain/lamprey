...
alter table room add column type room_type default 'Default';
alter table thread add column type thread_type default 'Default';
drop view message_coalesced;
drop view thread_json;
drop view message_json;
